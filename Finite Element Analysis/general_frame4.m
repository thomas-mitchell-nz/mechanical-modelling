...
% Element 4:
K4 = local_frame(E,I,A,L4); % Element stiffness matrix in local coords
[K4hat, Lambda4] = global_frame(K4,alpha4); % Global coords
KG4 = assembly_frame(K4hat,AM4); % Structural contribution
...
% --------------------------- Structural Terms ----------------------------
KG = KG1+KG2+KG3+KG4; % Structural stiffness matrix
...
% Element 4:
D4 = AM4'*q; % Global deflections
d4 = Lambda3*D4; % Local deflections
f4 = K4*d4; % Local nodal forces
F4 = K4hat*D4; % Global nodal forces

% --------------------------- Stress and Strain ---------------------------
strain1 = (d1(4)-d1(1))/L1;
strain2 = (d2(4)-d2(1))/L2;
strain3 = (d3(4)-d3(1))/L3;
strain4 = (d4(4)-d4(1))/L4;
...
Plot_deflected_shape(0,0,0,0,d3,L3,alpha3,Disp_mag,N_points); 
Plot_deflected_shape(0,0,0,0,d3,L3,alpha3,Disp_mag,N_points); 
